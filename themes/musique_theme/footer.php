...
<footer class="page-footer text-center font-small mt-4 wow bg-dark fadeIn">
    <div class="row">
        <div class="col-lg-4 pt-5">
            ...
            <div>
                <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2625.198279250918!2d2.3441018156971314!3d48.85442930893958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e671e04e0c9aa1%3A0xadf406cffe4d0399!2s1%20Rue%20de%20Lut%C3%A8ce%2C%2075004%20Paris!5e0!3m2!1sfr!2sfr!4v1599659808989!5m2!1sfr!2sfr" width="150" height="150" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
        </div>
         <div class="col-lg-4 pt-2 d-flex flex-column align-self-center">
            ...
            <form method="POST" action="#" class="d-flex justify-content-center" class="subscribe">
                <input type="text" class="form-control mr-3" placeholder="Email" style="width:200px;">
    ...
    <div class="pb-4">
        ...
        <a href="" target="_blank">
            <i class="fa fa-twitch fa-2x mr-3"></i>
        </a>
    </div>
